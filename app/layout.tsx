  ...
  return (
    <html lang="pt-BR" className="dark scroll-smooth">
      <body className={`font-sans antialiased`}>
        ...
        <Analytics />
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-99dfd29c-5030-418f-9db9-516fe0f22155" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_9y5ndRl38Qf?ref=X55XD7"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-99dfd29c-5030-418f-9db9-516fe0f22155').style.display='none'"
